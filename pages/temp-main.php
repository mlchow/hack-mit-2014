                            ...
                            <ul class="dropdown-menu dropdown-login">
                                    ...
                                    <div class="navbar-login">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                ?></strong></p>
                                                <p class="text-left small"><?php echo $_POST['email'];   ?></p>
                                                <div class="row">
                                                    <div class="col-md-6">
                                ...
                                <li>
                                    <div class="navbar-login navbar-login-session">
                                        <a href="../index.html" class="btn btn-default btn-square btn-block">Logout</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
			...
			query.find( {
			  success: function(juntoBoxEntry) {
                ...
                for (i=0;i<juntoBoxEntry.length;i++) {
					...
					stuff += (i+1) + ". " + juntoBoxEntry[i].get("foo")+"<br>";
