                            ...
                            <ul class="dropdown-menu dropdown-login">
                                ...
                                <li>
                                    <div class="navbar-login navbar-login-session">
                                        <a href="#" class="btn btn-default btn-square btn-block">Logout</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="active"><a href="#user" role="tab" data-toggle="tab"><i class="fa fa-user"></i></a></li>
                ...
                <ul class="sidebar-menu">
                    <li class="active">
                        <a href="http://hackprofile.com/pages/main.php">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="#"><i class="fa fa-circle-o"></i> Todo List</a></li>
                            <li><a href="#"><i class="fa fa-circle-o"></i> Draggable Portlet</a></li>
                            <li><a href="#"><i class="fa fa-circle-o"></i> Nestable</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
...
$(document).ready(function(){
 Parse.initialize("biMGnMGZKMRqeZFLXZDFQP84ln8gKqPzj0oV71TM", "B2422y5nyMJsGZF4K6GzAiTFJgwTZkHhOpcZ8Ovj");
	var currentUser = Parse.User.current();
			...
			var JuntoBox = Parse.Object.extend("Hackathons");
